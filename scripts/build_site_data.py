...
def spec_stats_frame(block: dict) -> "pd.DataFrame":
    """Flatten a specstats block to long-format rows (one per spec x stat x quantile)."""
    rows = []
...
# --------------------------------------------------------------------------
# Weekly reset schedule, mirroring the dashboard's client-side rules (the
# partition tests assert the two tables agree). The LLM export that used to
# live here was removed on 2026-09-02 at the owner's request.
# --------------------------------------------------------------------------
